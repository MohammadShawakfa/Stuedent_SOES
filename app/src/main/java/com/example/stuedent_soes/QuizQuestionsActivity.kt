...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    lateinit var ProgressBarET: ProgressBar
    lateinit var tv_progressET: TextView
    lateinit var tv_question: TextView
    lateinit var iv_imageET: ImageView
    ...
    lateinit var btn_submitET: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ProgressBarET = findViewById<ProgressBar>(R.id.progressBar)
        tv_progressET = findViewById<TextView>(R.id.tv_progress)
        tv_question = findViewById<TextView>(R.id.tv_question)
        iv_imageET = findViewById<ImageView>(R.id.iv_image)
        tv_optionOne = findViewById<TextView>(R.id.tv_option_one)
        tv_optionTwo = findViewById<TextView>(R.id.tv_option_two)
        tv_optionThree = findViewById<TextView>(R.id.tv_option_three)
        tv_optionFour = findViewById<TextView>(R.id.tv_option_four)
        btn_submitET = findViewById<Button>(R.id.btn_submit)
        ...
        btn_submitET.setOnClickListener(this)
    ...
    private fun setQuestion(){
        ...
        if(mCurrentPosition==mQuestionsList!!.size){
            btn_submitET.text = "FINISH"
        }else{
            btn_submitET.text ="SUBMIT"
        }

        ProgressBarET.progress=mCurrentPosition


        tv_progressET.text="$mCurrentPosition" + "/" + ProgressBarET.max


        tv_question.text=question!!.question


        iv_imageET.setImageResource(question.image)
            ...
            R.id.btn_submit ->{
                ...
                if(question!!.correctAnswer != mSelectedOptionPosition){
                    ...
                    if(mCurrentPosition == mQuestionsList!!.size){
                        ...
                        btn_submitET.text="GO TO NEXT QUESTION"
                    }
